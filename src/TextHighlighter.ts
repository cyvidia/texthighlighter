...
const TextHighlighter: TextHighlighterType = function (
  this: TextHighlighterSelf,
  element: HTMLElement,
  options?: optionsImpl
) {
  if (!element) {
...
TextHighlighter.prototype.mergeSiblingHighlights = function (
  highlights: any[]
) {
...
TextHighlighter.prototype.getHighlights = function (params?: paramsImp) {
  getHighlightElements(this.el, params);
};
...
TextHighlighter.prototype.deserializeHighlights = function (
