...
TextHighlighter.prototype.doHighlight = function (id, keepRange) {
    Library_1.doHighlight(this.el, id, keepRange, this.options);
};
TextHighlighter.prototype.highlightRange = function (id, range, wrapper) {
    Library_1.highlightRange(this.el, id, range, wrapper);
};
...
TextHighlighter.prototype.getHighlights = function (params) {
    Library_1.getHighlightElements(this.el, params);
};
...
TextHighlighter.prototype.deserializeHighlights = function (hlDescriptors) {
    Library_1.deserializeHighlights(this.el, hlDescriptors);
};
